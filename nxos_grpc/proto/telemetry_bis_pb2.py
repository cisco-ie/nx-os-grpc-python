...
# source: nxos_grpc/proto/telemetry_bis.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='nxos_grpc/proto/telemetry_bis.proto',
  package='',
  syntax='proto3',
  serialized_options=_b('Z\rtelemetry_bis'),
...
Telemetry = _reflection.GeneratedProtocolMessageType('Telemetry', (_message.Message,), dict(
  ...
  __module__ = 'nxos_grpc.proto.telemetry_bis_pb2'
